...
import { Breadcrumb, Button, Col, Descriptions, Divider, Dropdown, Image, Menu, PageHeader, Row } from 'antd'
    ...
    <PageHeader
      ...
      <Row gutter={[16, 16]}>
        <Col
          ...
          md={{ span: 24, offset: 0 }}
          lg={{ span: 24, offset: 0 }}>
          <Descriptions title="Сообщения"  column={{ xxl: 4, xl: 2, lg: 2, md: 1, sm: 1, xs: 1 }}>
        ...
        <Col
          ...
          md={{ span: 24, offset: 0 }}
          lg={{ span: 12, offset: 0 }}>
          <Descriptions title="Сообщения"  column={{ xxl: 2, xl: 2, lg: 2, md: 1, sm: 1, xs: 1 }}>
