...
const Services = ({ login }) => {
  ...
  let tariffDescription = [
    {
      text: '1. Для подключения и использования тарифа скорость которого превышает 100 Мбит/сек обязательно наличие поддерживаемого оборудования: - в технических характеристиках роутера или маршрутизатора должна быть указана поддержка N300 и выше; - сетевая карта с поддержкой 1 Гбит/сек, Роутер с поддержкой 1 Гбит/сек; - подключение производится с помощью кабеля стандарта UTP категории 5E. ',
    },
    {
      text: '2. Подключение выполняется в течении двух дней с момента внесения авансового платежа.',
    },
    {
      text: '3. Рассмотрение технической возможности подключения заявки выполняется в течении трех дней.',
    },
    {
      text: ' 4. Настройка вашего оборудования – бесплатно (*единоразово при подключении).',
    },
  ]
  let ktvDescription = [
    {
